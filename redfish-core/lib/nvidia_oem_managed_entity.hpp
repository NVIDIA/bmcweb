    ...
    const dbus::utility::DBusPropertiesMap& properties)
{
    ...
    asyncResp->res.jsonValue["@odata.id"] = boost::urls::format(
        "/redfish/v1/Managers/{}/ManagedEntityGroups/{}/ManagedEntities/{}",
    ...
    const std::string& entityId)
{
    ...
    if (!json_util::readJsonPatch(req, asyncResp->res, "IPv4Address/Address",
                                  newIPv4Address, "IPv6Address/Address",
                                  newIPv6Address, "Name", newName, "Port",
...
inline void requestRoutesNvidiaManagedEntity(App& app)
{
    ...
    BMCWEB_ROUTE(
        app,
        "/redfish/v1/Managers/<str>/Oem/Nvidia_PowerCompliance/ManagedEntityGroups/<str>/ManagedEntities/<str>/")
    ...
    BMCWEB_ROUTE(
        app,
        "/redfish/v1/Managers/<str>/Oem/Nvidia_PowerCompliance/ManagedEntityGroups/<str>/ManagedEntities/")
        .privileges(redfish::privileges::getManager)
