    ...
    const std::string& managerId, const std::string& id)
{
    ...
    dbus::utility::getAllProperties("com.Nvidia.RackPowerCompliance", dbusPath,
                                    "com.Nvidia.State.PowerCompliance.PscState",
                                    std::move(callback));
}
...
inline void requestRoutesNvidiaPscState(App& app)
{
    ...
    BMCWEB_ROUTE(
        app,
        "/redfish/v1/Managers/<str>/Oem/Nvidia/PowerCompliance/PowerStateGroup/PowerShelfControllers/<str>/")
    ...
    BMCWEB_ROUTE(
        app,
        "/redfish/v1/Managers/<str>/Oem/Nvidia/PowerCompliance/PowerStateGroup/PowerShelfControllers/")
        .privileges(redfish::privileges::getManager)
        .methods(boost::beast::http::verb::get)(
