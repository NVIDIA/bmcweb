        ...
        mctpVdmUtilWrapper.run(
            ...
            [systemName, resourceUri,
             resUri](const std::shared_ptr<bmcweb::AsyncResp>& asyncResp1,
                ...
                {
                    messages::debugTokenUnsupported(asyncResp1->res,
                                                    systemName);
                    return;
                }
