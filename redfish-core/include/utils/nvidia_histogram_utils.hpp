                    ...
                    for (const auto& property : properties)
                    {
                        ...
                        if (propertyName == "BucketData")
                        {
                            const std::vector<std::tuple<
                                ...
                                value = std::get_if<std::vector<std::tuple<
                                    uint16_t,
                            ...
                            for (const auto& [index, data] : *value)
                            {
                                ...
                                const auto& [start, end, bucketValue] = data;
                                ...
                                bucketsArr["Value"] =
                                    static_cast<uint64_t>(bucketValue);
