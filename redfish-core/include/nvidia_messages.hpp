...
inline nlohmann::json debugTokenEraseSkipped(std::string_view arg1)
{
    std::array<std::string_view, 1> args{arg1};
    return getLogNvidia(
        redfish::registries::NvidiaUpdate::Index::debugTokenEraseSkipped, args);
}
...
inline nlohmann::json enterDOTRecovery(std::string_view arg1)
{
    std::array<std::string_view, 1> args{arg1};
    return getLogNvidia(
        redfish::registries::NvidiaUpdate::Index::enterDOTRecovery, args);
}
