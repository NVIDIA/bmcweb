...
class Handler : public std::enable_shared_from_this<Handler>
{
  ...
  private:
    Handler(Operation op, Argument arg, ResultCallback callback) :
        op(op), arg(arg), callback(callback)
    {}
    ...
    void run()
    {
        ...
        dbus::utility::getSubTree(std::string(debugTokenBasePath), 0,
                                  interfaces,
