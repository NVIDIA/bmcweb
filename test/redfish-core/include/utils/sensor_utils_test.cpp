...
TEST(MapPropertiesBySubnode, Success)
{
    ...
    expectedProps = {
        ...
        {"xyz.openbmc_project.Sensor.ReadingBasis", "ReadingBasis",
         "/ReadingBasis"_json_pointer},
        {"xyz.openbmc_project.Sensor.Description", "Description",
         "/Description"_json_pointer},
        {"xyz.openbmc_project.Sensor.PeakValue", "PeakValue",
         "/PeakReading"_json_pointer},
        {"xyz.openbmc_project.Sensor.PeakValue", "Timestamp",
        ...
        {"xyz.openbmc_project.Inventory.Decorator.Area", "PhysicalContext",
         "/PhysicalContext"_json_pointer},
        {"xyz.openbmc_project.Sensor.Type", "Implementation",
